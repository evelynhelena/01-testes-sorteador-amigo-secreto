...
export function Form() {
    ...
    return (
        <div className="w-full flex justify-center flex-col items-center gap-8">
            <p className="text-2xl">Vamos começar!</p>
            <form onSubmit={addParticipants} className="w-full max-w-[500px] flex">
                <input
                    className="border-b-5 border-2 w-full p-[17px] rounded-l-[37px]"
                    ref={inputRef}
                ...
                <button
                    className={`${!particpantName && 'cursor-not-allowed'} p-[17px] rounded-r-[37px] border-b-5 border-2 w-[255px] bg-color-gray`}
